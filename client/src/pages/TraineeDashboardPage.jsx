...
const TraineeDashboardPage = () => {
  return (
    <PageContainer
      ...
      subtitle="Learner capacity building workspace"
    >
      <div className="bg-white border border-slate-200 rounded p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-900">Trainee Dashboard</h2>
        <p className="text-sm font-semibold text-emerald-600 mt-2">Phase 1 Foundation</p>
        <p className="text-xs text-slate-500 mt-2 max-w-md mx-auto leading-relaxed">
          Course enrollments, progress tracking, competency development, and AI assistant features will be connected in future phases.
        </p>
